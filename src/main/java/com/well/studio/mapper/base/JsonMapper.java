...
public class JsonMapper {
    ...
    public JsonMapper(JsonInclude.Include include, Boolean isJsonTypeIgnore) {
    ...
    public static JsonMapper nonEmptyMapper() {
        return new JsonMapper(JsonInclude.Include.NON_EMPTY, true);
    }
    ...
    public static JsonMapper nonDefaultMapper() {
        return new JsonMapper(JsonInclude.Include.NON_DEFAULT, true);
    }
    ...
    public <T> List<T> fromJsonToList(String jsonString, Class<T> outClass) {
        if (StringUtils.isEmpty(jsonString)) {
            return null;
        }
        try {
            JavaType javaType = this.createCollectionType(List.class, outClass);
