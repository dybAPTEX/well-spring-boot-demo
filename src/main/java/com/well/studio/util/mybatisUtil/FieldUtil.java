...
public final class FieldUtil {
    ...
    public static boolean isBaseDataType(@SuppressWarnings("rawtypes") Class clazz) {
        return (clazz.equals(String.class) || clazz.equals(Integer.class) || clazz.equals(Byte.class)
                || clazz.equals(Long.class) || clazz.equals(Double.class) || clazz.equals(Float.class) || clazz.isEnum()
                || clazz.equals(Character.class) || clazz.equals(Short.class) || clazz.equals(BigDecimal.class)
                || clazz.equals(BigInteger.class) || clazz.equals(Boolean.class) || clazz.equals(Date.class)
                || clazz.equals(List.class) || clazz.isPrimitive());
    }
     ...
     * 将对象中异常的日期转为普通的日期
     * <p>
     * 2020-03-19 bg405768 单元测试报错太多，将修改Integer/Long类型的值为1
     */
    ...
    public static void formatDate(Object bo) {
        ...
        for (Method method : methodsArray) {
            ...
            if (methodName.startsWith(SET) && parameterTypes != null && parameterTypes.length > 0
            ...
            } else if (methodName.startsWith(SET) && parameterTypes != null && parameterTypes.length > 0
                ...
                try {
                    ...
                    && parameterTypes[0].isAssignableFrom(Integer.class)) {
                try {
                    method.invoke(bo, 1);
                } catch (IllegalAccessException | InvocationTargetException e) {
                    LOG.error("异常", e);
                    ...
                    && parameterTypes[0].isAssignableFrom(Long.class)) {
                try {
                    method.invoke(bo, 2L);
                } catch (IllegalAccessException | InvocationTargetException e) {
                    LOG.error("异常", e);
